  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      <div>
        ...
        <p className="text-sm sm:text-base text-gray-600">View and compare raw data with AI-generated summaries.</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-8 sm:py-12">
          ...
          <h3 className="mt-3 sm:mt-4 text-base sm:text-lg font-medium text-gray-900">No documents yet</h3>
          <p className="mt-1 text-xs sm:text-sm text-gray-500">Upload some files to see them here.</p>
        </div>
      ) : (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {items.map((item) => (
            <div key={item._id} className="bg-white rounded-xl shadow-md p-4 overflow-hidden">
              {/* Card Header */}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <div>
                  ...
                  <div className="bg-gray-100 rounded-lg p-3 h-48 overflow-y-auto">
                    <pre className="text-xs whitespace-pre-wrap">{item.text || 'No raw data available'}</pre>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="bg-gray-100 rounded-lg p-3 h-48 overflow-y-auto">
                    <p className="text-xs">{item.summary || 'No summary available'}</p>
                  </div>
                </div>
              </div>
